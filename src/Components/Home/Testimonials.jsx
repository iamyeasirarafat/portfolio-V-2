...
const Testimonials = () => (
  <div id="testimonial" className="w-full py-[57px]">
    <div className="flex items-center">
      ...
      <div className="w-1/2 relative">
        ...
        <p className="text-2xl text-white font-bold">WHAT OUR CLIENT SAY</p>
        ...
        <div className="relative">
          <p className="font-normal text-base text-secondary leading-[190%]">
            Lorem Ipsum is simply dummy text of the printing andtypesetting
            industry. Lorem Ipsum has been the industry standard dummy. text
            ever since the 1500s, when an. Lorem ipsum dolor sit amet,
            consectetur adipisicing elit. Laborum, laboriosam.
          </p>
          <img
        ...
        <div className="pt-[115px] flex items-center justify-between">
          <div className="w-[83%] bg-secondary h-[2px]">
            <div className="w-[25%] bg-primary h-[2px]"></div>
          </div>
