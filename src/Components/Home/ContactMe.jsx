...
const ContactMe = () => {
  return (
    <div id="contact" className="w-full py-14">
      <div className="flex">
        <div className="w-1/2">
        ...
        <div className="w-1/2">
          <form className="flex flex-col gap-y-8">
            ...
            />
            <button className="text-primary outline-none bg-[#ffffff0d] border border-primary rounded-xl py-[15px] px-[50px] text-lg font-medium mr-auto mt-5">
              Send
            </button>
          </form>
        </div>
